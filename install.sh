...
main() {
  ...
  sudo pacman -Syyu xorg xorg-init xorg-twm xorg-xbacklight zsh udisks2 alsa-utils dmenu pulseaudio pavucontrol pulseaudio-bluetooth blueman bluez-utils pulseaudio-alsa i3-gaps rsync bc xterm reflector i3status
